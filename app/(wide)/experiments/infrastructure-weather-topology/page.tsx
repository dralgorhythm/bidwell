    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="prose max-w-none">
                <p>
                    This concept visualizes the global internet topology as a 3D globe where network performance
                    metrics (latency, packet loss) are rendered as atmospheric weather conditions. A DDoS attack
                    looks like a storm and a cable cut looks like a void.
                </p>
