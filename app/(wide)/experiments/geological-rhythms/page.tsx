    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="prose max-w-none">
                <p>
                    Geological Rhythms transforms the Earth's tectonic activity into a polyrhythmic percussion engine.
                    Listen to the "heartbeat" of the planet as seismic data becomes a visceral experience of energy release.
                </p>
