    ...
    <section>
      ...
      <div className='mb-12'>
        ...
        <p className='mb-4 text-neutral-700 dark:text-neutral-300'>
          I&apos;m Jordan Winters - an independent consultant with over a decade in software. Every
          engagement is with me directly: the person you talk to on the discovery call is the person
          who does the work. I&apos;m based in Minneapolis and work with companies across the Twin
          Cities metro, and remotely everywhere else.
        </p>
      ...
      <div className='mb-12'>
        ...
        <p className='mb-4 text-neutral-700 dark:text-neutral-300'>
          ...
          person by design, which means one point of contact and no handoffs.
        </p>
      </div>
