...
export const metadata: Metadata = {
    title: "Experiments",
    description:
        "Explore interactive experiments and prototypes built by Bidwell Consulting.",
};

function ExperimentCard({
    experiment,
}: { experiment: Experiment }): React.JSX.Element {
    ...
    return (
        <section>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 mb-8">
                A collection of interactive experiments, prototypes, and explorations.
                Each experiment has its own dedicated space to showcase ideas without
                constraints.
            </p>
