...
describe("Experiments Index Page", () => {
    describe("rendering", () => {
        it("renders the page title", () => {
            ...
            expect(
                screen.getByRole("heading", { level: 1, name: /experiments/i }),
            ).toBeInTheDocument();
        });
        ...
        it("renders the page description", () => {
            render(<ExperimentsPage />);
            expect(
                screen.getByText(/collection of interactive experiments/i),
            ).toBeInTheDocument();
        });
    ...
    describe("experiment cards", () => {
        ...
        it("displays category labels for experiments", () => {
            ...
            expect(screen.getAllByText("Auditory Interface").length).toBeGreaterThan(
                0,
            );
    ...
    describe("SEO", () => {
        it("has descriptive content for search engines", () => {
            ...
            expect(
                screen.getByText(/interactive experiments, prototypes/i),
            ).toBeInTheDocument();
        });
